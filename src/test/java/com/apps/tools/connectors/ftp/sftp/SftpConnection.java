...
public class SftpConnection {
	 ...
	 */
	private static void createSftpConnection(String SFTPHOST, String SFTPPORT, String SFTPUSER, File mysshFile,
			String SFTPWORKINGDIR) throws JSchException {
		Logger logger = LoggerFactory.getLogger(Constants.REPORT_TEST_NAME);
		JSch jSch = new JSch();
		Assert.assertTrue("Invalid key for connection to sftp. Please provide a valid private key. Current key: "
				+ mysshFile.getAbsolutePath(), !mysshFile.getAbsolutePath().contains(".key"));
